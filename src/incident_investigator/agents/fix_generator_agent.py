...
from incident_investigator.models.fix_recommendation import FixRecommendation
...
- Mark destructive, production-changing, rollback, deployment, credential, or
  infrastructure operations as requiring approval.
- Do not include secrets or fabricate environment values.
"""


def create_fix_generator_agent(model_name: str) -> Agent:
    return Agent(
        name="Fix Generator",
